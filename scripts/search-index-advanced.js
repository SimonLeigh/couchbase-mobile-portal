...
"docDescriptions":[
"A high-level introduction to the component parts of the Coucbhase Mobile product.",
"Introduction to Couchbase Mobile for Unity.",
"Become a Mobile Consulting Partner.",
"iOSのツールをインストール",
...
"PhoneGapのコマンドラインツールを使って、実際にサンプルアプリをビルドしてみましょう。",
...
"Introducing Views through code",
"",
"Create a new Couchbase Lite project for Xamarin.Android in Xamarin Studio",
"Create a new Couchbase Lite project for Xamarin.Android in Visual Studio",
"Create a manager and a database for CouchbaseEvents",
"Create, retrieve, update, and delete documents in the couchbaseevents database",
"Understanding Sync Gateway and setting up a connection to Couchbase Server",
"Introducing Views through code",
"",
"Create a new Couchbase Lite project for Xamarin.iOS in Xamarin Studio",
"Create a new Couchbase Lite project for Xamarin.iOS in Visual Studio",
"Create a manager and a database for CouchbaseEvents",
"Create, retrieve, update, and delete documents in the couchbaseevents database",
"Understanding Sync Gateway and setting up a connection to Couchbase Server",
"Introducing Views through code",
...
"Create a new Couchbase Lite project for WPF in Visual Studio",
"Create a manager and a database for CouchbaseEvents",
"Create, retrieve, update, and delete documents in the couchbaseevents database",
"Understanding Sync Gateway and setting up a connection to Couchbase Server",
"Introducing Views through code",
...
"この説明書はデータベース（Database）の使い方をご紹介します。データベースとはドキュメントの集まりになります。",
...
"この説明書は添付ファイル(Attachments)をご紹介します。添付ファイルはドキュメントと一緒にデータを保存する。データはMIMEファイルタイプが付いているバイナリーデータで、サイズは任意です。",
...
"There are two kinds of REST API for the Sync Gateway, one for syncing with Couchbase Lite endpoints, and the other for administering access to the system. This article demonstrates how to administer for both.",
...
"This article walks you through on how to define a view using the TodoLite sample app. There are a few special considerations when defining a view against a bucket used by Sync Gateway.",
"This article walks you through raising the maximum number of file descriptors available to Sync Gateway.",
"This article walks you through tuning the TCP Keepalive parameters.",
...
"保存終了のDocumentのRevision",
"Couchbase LiteのDocumentの未保存Revision",
"Couchbase LiteのDocumentのAttachment",
"Couchbase LiteのView。ViewとはMap/Reduce関数によって管理されるインデックス",
"ソースをMapDelegateとReduceDelegateにコンパイルするオブジェクト",
...
"サーバーの情報を取得します",
"サーバーで実行中のタスクをすべて取得します。",
"すべてのデータベースを取得します",
"データベースの同期",
"セッション情報を取得します",
"データベースのIDを取得しますRetrieve database identifiers",
...
"",
"Retrieve specified rows from a view Create a design document",
...
"Create a new user",
"Delete a user",
"1.1.0 Release Notes for Sync Gateway",
"1.0.4 Release Notes for Sync Gateway",
